...
public class GTBedrockFluids {
    ...
    private static void register(BootstapContext<BedrockFluidDefinition> context,
    ...
    public static void bootstrap(BootstapContext<BedrockFluidDefinition> context) {
