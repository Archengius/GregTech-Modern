...
public class GTPlacementModifiers {
    ...
    private static final DeferredRegister<PlacementModifierType<?>> PLACEMENT_MODIFIER_TYPE = DeferredRegister
            .create(Registries.PLACEMENT_MODIFIER_TYPE, GTCEu.MOD_ID);

    public static final RegistryObject<PlacementModifierType<BiomePlacement>> BIOME_PLACEMENT = PLACEMENT_MODIFIER_TYPE
            .register("biome_placement", () -> () -> BiomePlacement.CODEC);
    public static final RegistryObject<PlacementModifierType<DimensionFilter>> DIMENSION_FILTER = PLACEMENT_MODIFIER_TYPE
            .register("dimension", () -> () -> DimensionFilter.CODEC);
    public static final RegistryObject<PlacementModifierType<FrequencyModifier>> FREQUENCY = PLACEMENT_MODIFIER_TYPE
            .register("frequency", () -> () -> FrequencyModifier.CODEC);
    public static final RegistryObject<PlacementModifierType<RubberTreeChancePlacement>> RUBBER_TREE_PLACEMENT = PLACEMENT_MODIFIER_TYPE
