...
public final class GeneratedVeinMetadata {
    ...
    public static GeneratedVeinMetadata readFromPacket(FriendlyByteBuf buf) {
        ...
        Holder<GTOreDefinition> def = GTRegistries.builtinRegistry().lookupOrThrow(GTRegistries.Keys.ORE_VEIN)
                .getOrThrow(buf.readResourceKey(GTRegistries.Keys.ORE_VEIN));
    ...
    public void writeToPacket(FriendlyByteBuf buf) {
        ...
        buf.writeResourceKey(GTRegistries.Keys.ORE_VEIN);
    }
