...
public class GTOreVeinDisplayCategory extends ModularUIREIDisplayCategory<GTOreVeinDisplayCategory.GTOreVeinDisplay> {
    ...
    public static void registerDisplays(DisplayRegistry registry) {
        for (var oreDefinition : Objects.requireNonNull(Minecraft.getInstance().level).registryAccess()
                .registryOrThrow(GTRegistries.Keys.ORE_VEIN).entrySet()) {
            registry.add(new GTOreVeinDisplay(oreDefinition.getKey().location(), oreDefinition.getValue()));
        }
    }
