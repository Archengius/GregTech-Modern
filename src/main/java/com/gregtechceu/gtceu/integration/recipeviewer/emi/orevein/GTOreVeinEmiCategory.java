...
public class GTOreVeinEmiCategory extends EmiRecipeCategory {
    ...
    public static void registerDisplays(EmiRegistry registry) {
        for (GTOreDefinition oreDefinition : Objects.requireNonNull(Minecraft.getInstance().level).registryAccess()
    ...
    public static class GTEmiOreVein extends ModularUIEmiRecipe {
        ...
        public GTEmiOreVein(GTOreDefinition oreDefinition) {
            super(Objects.requireNonNull(Objects.requireNonNull(Minecraft.getInstance().level).registryAccess()
                            .registryOrThrow(GTRegistries.Keys.ORE_VEIN).getKey(oreDefinition)).withPrefix("/ore_vein_diagram/"),
