...
public class GTBedrockFluidEmiCategory extends EmiRecipeCategory {
    ...
    public static void registerDisplays(EmiRegistry registry) {
        for (BedrockFluidDefinition fluid : Objects.requireNonNull(Minecraft.getInstance().level).registryAccess()
    ...
    public static class GTBedrockFluid extends ModularUIEmiRecipe {
        ...
        public GTBedrockFluid(BedrockFluidDefinition fluid) {
            super(Objects.requireNonNull(Objects.requireNonNull(Minecraft.getInstance().level).registryAccess()
                            .registryOrThrow(GTRegistries.Keys.BEDROCK_FLUID).getKey(fluid)).withPrefix("/bedrock_fluid_diagram/"),
