...
public class GTBedrockFluidVeinEventJS extends EventJS {
    ...
    public void modify(ResourceLocation id, Consumer<BedrockFluidDefinitionBuilderJS> consumer) {
    ...
    public void modifyAll(BiConsumer<ResourceLocation, BedrockFluidDefinitionBuilderJS> consumer) {
    ...
    public void removeAll(BiPredicate<ResourceLocation, BedrockFluidDefinition> predicate) {
        Set<ResourceLocation> keys = Set.copyOf(registry.keySet());
        keys.stream()
