...
public class OreVeinDefinitionBuilderJS {
    ...
    private static ResourceKey<Level> wrapDimension(Object dim) {
        ...
        return ResourceKey.create(Registries.DIMENSION, new ResourceLocation(dim.toString()));
    }
    ...
    public GTOreDefinition createObject() {
        var registries = UtilsJS.staticRegistryAccess;
        ...
        return new GTOreDefinition(clusterSize, density, weight, layer,
                ...
                biomes == null ? HolderSet.direct() : biomes,
